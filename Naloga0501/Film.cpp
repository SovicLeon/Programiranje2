...
Film::Film(std::string title, Artist *artist, std::string description, int price, int year, unsigned int length,
...
std::string Film::toString() const {
    ...
    return title + " " + artist->toString() + " " + description + " " + priceString + " " + yearString + " " + lengthString + " " + ratingString + " " + genreString;
}
